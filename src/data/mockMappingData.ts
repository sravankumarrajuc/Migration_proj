...
export const customerMappings: FieldMapping[] = [
  { id: 'map-cust-1', sourceTableId: 'src-db2-customers', sourceColumnId: 'CUST_ID', targetTableId: 'tgt-bq-customers', targetColumnId: 'customer_id', transformationType: 'direct', confidence: 95, status: 'suggested', description: 'Direct map of customer ID.', createdAt: now },
  { id: 'map-cust-2', sourceTableId: 'src-db2-customers', sourceColumnId: 'NAME_JSON', targetTableId: 'tgt-bq-customers', targetColumnId: 'name_first', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(NAME_JSON, '$.first')", confidence: 75, status: 'suggested', description: 'Extract first name from JSON.', createdAt: now },
  { id: 'map-cust-3', sourceTableId: 'src-db2-customers', sourceColumnId: 'NAME_JSON', targetTableId: 'tgt-bq-customers', targetColumnId: 'name_last', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(NAME_JSON, '$.last')", confidence: 75, status: 'suggested', description: 'Extract last name from JSON.', createdAt: now },
  { id: 'map-cust-4', sourceTableId: 'src-db2-customers', sourceColumnId: 'REGION_CD', targetTableId: 'tgt-bq-customers', targetColumnId: 'region_code', transformationType: 'direct', confidence: 92, status: 'suggested', description: 'Direct map of region code.', createdAt: now },
  { id: 'map-cust-5', sourceTableId: 'src-db2-customers', sourceColumnId: 'SEGMENT', targetTableId: 'tgt-bq-customers', targetColumnId: 'customer_segment', transformationType: 'direct', confidence: 92, status: 'suggested', description: 'Direct map of customer segment.', createdAt: now },
  { id: 'map-cust-6', sourceTableId: 'src-db2-customers', sourceColumnId: 'DOB', targetTableId: 'tgt-bq-customers', targetColumnId: 'date_of_birth', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of date of birth.', createdAt: now },
  { id: 'map-cust-7', sourceTableId: 'src-db2-customers', sourceColumnId: 'EMAIL', targetTableId: 'tgt-bq-customers', targetColumnId: 'email_address', transformationType: 'direct', confidence: 95, status: 'suggested', description: 'Direct map of email.', createdAt: now },
  { id: 'map-cust-8', sourceTableId: 'src-db2-customers', sourceColumnId: 'PHONE', targetTableId: 'tgt-bq-customers', targetColumnId: 'phone_number', transformationType: 'direct', confidence: 92, status: 'suggested', description: 'Direct map of phone number.', createdAt: now },
  { id: 'map-cust-9', sourceTableId: 'src-db2-customers', sourceColumnId: 'ADDR_JSON', targetTableId: 'tgt-bq-customers', targetColumnId: 'address_street', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(ADDR_JSON, '$.street')", confidence: 70, status: 'suggested', description: 'Extract street from JSON.', createdAt: now },
  { id: 'map-cust-10', sourceTableId: 'src-db2-customers', sourceColumnId: 'ADDR_JSON', targetTableId: 'tgt-bq-customers', targetColumnId: 'address_city', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(ADDR_JSON, '$.city')", confidence: 70, status: 'suggested', description: 'Extract city from JSON.', createdAt: now },
  { id: 'map-cust-11', sourceTableId: 'src-db2-customers', sourceColumnId: 'ADDR_JSON', targetTableId: 'tgt-bq-customers', targetColumnId: 'address_state', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(ADDR_JSON, '$.state')", confidence: 70, status: 'suggested', description: 'Extract state from JSON.', createdAt: now },
  { id: 'map-cust-12', sourceTableId: 'src-db2-customers', sourceColumnId: 'ADDR_JSON', targetTableId: 'tgt-bq-customers', targetColumnId: 'address_postcode', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(ADDR_JSON, '$.zip')", confidence: 70, status: 'suggested', description: 'Extract zip from JSON.', createdAt: now },
  { id: 'map-cust-13', sourceTableId: 'src-db2-customers', sourceColumnId: 'JOIN_DT', targetTableId: 'tgt-bq-customers', targetColumnId: 'joined_on', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of join date.', createdAt: now },
  { id: 'map-cust-14', sourceTableId: 'src-db2-customers', sourceColumnId: 'STATUS', targetTableId: 'tgt-bq-customers', targetColumnId: 'active_flag', transformationType: 'case_when', formula: "CASE WHEN STATUS = 'A' THEN 'Active' ELSE 'Inactive' END", confidence: 80, status: 'suggested', description: 'Map status flag to descriptive string.', createdAt: now },
  { id: 'map-cust-15', sourceTableId: 'src-db2-customers', sourceColumnId: 'PREF_CHANNEL', targetTableId: 'tgt-bq-customers', targetColumnId: 'preferred_contact', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of preferred channel.', createdAt: now },
  { id: 'map-cust-16', sourceTableId: 'src-db2-customers', sourceColumnId: 'RISK_SCORE', targetTableId: 'tgt-bq-customers', targetColumnId: 'customer_risk_score', transformationType: 'cast', formula: 'CAST(RISK_SCORE AS NUMERIC)', confidence: 75, status: 'suggested', description: 'Cast risk score to NUMERIC.', createdAt: now },
];

// Mappings for src-db2-claims and related tables -> tgt-bq-claims
export const claimsMappings: FieldMapping[] = [
  { id: 'map-claims-1', sourceTableId: 'src-db2-claims', sourceColumnId: 'CLM_ID', targetTableId: 'tgt-bq-claims', targetColumnId: 'claim_identifier', transformationType: 'direct', confidence: 95, status: 'suggested', description: 'Direct map of claim ID.', createdAt: now },
  { id: 'map-claims-2', sourceTableId: 'src-db2-claims', sourceColumnId: 'POLICY_REF', targetTableId: 'tgt-bq-claims', targetColumnId: 'policy_code', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of policy reference.', createdAt: now },
  { id: 'map-claims-3', sourceTableId: 'src-db2-claims', sourceColumnId: 'CUSTOMER_REF', targetTableId: 'tgt-bq-claims', targetColumnId: 'client_key', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of customer reference.', createdAt: now },
  { id: 'map-claims-4', sourceTableId: 'src-db2-claims', sourceColumnId: 'CLM_DT', targetTableId: 'tgt-bq-claims', targetColumnId: 'claim_open_date', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of claim date.', createdAt: now },
  { id: 'map-claims-5', sourceTableId: 'src-db2-claims', sourceColumnId: 'CLM_STATUS', targetTableId: 'tgt-bq-claims', targetColumnId: 'status_code', transformationType: 'cast', formula: 'CAST(CLM_STATUS AS STRING)', confidence: 92, status: 'suggested', description: 'Cast status to STRING.', createdAt: now },
  { id: 'map-claims-6', sourceTableId: 'src-db2-claims', sourceColumnId: 'CLM_AMT', targetTableId: 'tgt-bq-claims', targetColumnId: 'claim_value', transformationType: 'cast', formula: 'CAST(CLM_AMT AS NUMERIC)', confidence: 92, status: 'suggested', description: 'Cast claim amount to NUMERIC.', createdAt: now },
  { id: 'map-claims-7', sourceTableId: 'src-db2-claims', sourceColumnId: 'ADJ_AMT', targetTableId: 'tgt-bq-claims', targetColumnId: 'adjustment_value', transformationType: 'cast', formula: 'CAST(ADJ_AMT AS NUMERIC)', confidence: 92, status: 'suggested', description: 'Cast adjustment amount to NUMERIC.', createdAt: now },
  { id: 'map-claims-8', sourceTableId: 'src-db2-claims', sourceColumnId: 'SETTLE_DT', targetTableId: 'tgt-bq-claims', targetColumnId: 'resolution_date', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of settlement date.', createdAt: now },
  { id: 'map-claims-9', sourceTableId: 'src-db2-claims', sourceColumnId: 'CLAIM_JSON', targetTableId: 'tgt-bq-claims', targetColumnId: 'claim_detail_json', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of claim JSON.', createdAt: now },
  { id: 'map-claims-10', sourceTableId: 'src-db2-claims', sourceColumnId: 'LOSS_TYPE', targetTableId: 'tgt-bq-claims', targetColumnId: 'loss_category', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of loss type.', createdAt: now },
  { id: 'map-claims-11', sourceTableId: 'src-db2-claims', sourceColumnId: 'REPORTED_BY', targetTableId: 'tgt-bq-claims', targetColumnId: 'report_owner', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of reporter.', createdAt: now },
  { id: 'map-claims-12', sourceTableId: 'src-db2-claims', sourceColumnId: 'INCIDENT_LOC', targetTableId: 'tgt-bq-claims', targetColumnId: 'incident_address', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of incident location.', createdAt: now },
  { id: 'map-claims-13', sourceTableId: 'src-db2-claims', sourceColumnId: 'INCIDENT_DT', targetTableId: 'tgt-bq-claims', targetColumnId: 'incident_timestamp', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of incident timestamp.', createdAt: now },
  { id: 'map-claims-14', sourceTableId: 'src-db2-claims', sourceColumnId: 'DAYS_OPEN', targetTableId: 'tgt-bq-claims', targetColumnId: 'days_to_resolution', transformationType: 'cast', formula: 'CAST(DAYS_OPEN AS INT64)', confidence: 90, status: 'suggested', description: 'Cast days open to INT64.', createdAt: now },
  { id: 'map-claims-15', sourceTableId: 'src-db2-claims', sourceColumnId: 'PRIORITY_CD', targetTableId: 'tgt-bq-claims', targetColumnId: 'priority_level', transformationType: 'cast', formula: 'CAST(PRIORITY_CD AS STRING)', confidence: 90, status: 'suggested', description: 'Cast priority code to STRING.', createdAt: now },
  { id: 'map-claims-payments', sourceTableId: 'src-db2-payments', sourceColumnId: '*', targetTableId: 'tgt-bq-claims', targetColumnId: 'payments', transformationType: 'custom', formula: 'ARRAY_AGG(STRUCT(...)) FROM DB2_PAYMENTS', confidence: 92, status: 'suggested', description: 'Aggregate payments into a nested array.', createdAt: now },
  { id: 'map-claims-adjustments', sourceTableId: 'src-db2-adjustments', sourceColumnId: '*', targetTableId: 'tgt-bq-claims', targetColumnId: 'adjustments', transformationType: 'custom', formula: 'ARRAY_AGG(STRUCT(...)) FROM DB2_ADJUSTMENTS', confidence: 90, status: 'suggested', description: 'Aggregate adjustments into a nested array.', createdAt: now },
  { id: 'map-claims-events', sourceTableId: 'src-db2-claim-events', sourceColumnId: '*', targetTableId: 'tgt-bq-claims', targetColumnId: 'events', transformationType: 'custom', formula: 'ARRAY_AGG(STRUCT(...)) FROM DB2_CLAIM_EVENTS', confidence: 90, status: 'suggested', description: 'Aggregate events into a nested array.', createdAt: now },
];
