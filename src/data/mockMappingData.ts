...
export const customerMappings: FieldMapping[] = [
  { id: 'map-cust-1', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'CUST_ID', targetTableId: 'customers_denorm', targetColumnId: 'customer_id', transformationType: 'direct', confidence: 95, status: 'suggested', description: 'Direct map of customer ID.', createdAt: now },
  { id: 'map-cust-2', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'NAME_JSON', targetTableId: 'customers_denorm', targetColumnId: 'name_first', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(NAME_JSON, '$.first')", confidence: 75, status: 'suggested', description: 'Extract first name from JSON.', createdAt: now },
  { id: 'map-cust-3', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'NAME_JSON', targetTableId: 'customers_denorm', targetColumnId: 'name_last', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(NAME_JSON, '$.last')", confidence: 75, status: 'suggested', description: 'Extract last name from JSON.', createdAt: now },
  { id: 'map-cust-4', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'REGION_CD', targetTableId: 'customers_denorm', targetColumnId: 'region_code', transformationType: 'direct', confidence: 92, status: 'suggested', description: 'Direct map of region code.', createdAt: now },
  { id: 'map-cust-5', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'SEGMENT', targetTableId: 'customers_denorm', targetColumnId: 'customer_segment', transformationType: 'direct', confidence: 92, status: 'suggested', description: 'Direct map of customer segment.', createdAt: now },
  { id: 'map-cust-6', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'DOB', targetTableId: 'customers_denorm', targetColumnId: 'date_of_birth', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of date of birth.', createdAt: now },
  { id: 'map-cust-7', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'EMAIL', targetTableId: 'customers_denorm', targetColumnId: 'email_address', transformationType: 'direct', confidence: 95, status: 'suggested', description: 'Direct map of email.', createdAt: now },
  { id: 'map-cust-8', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'PHONE', targetTableId: 'customers_denorm', targetColumnId: 'phone_number', transformationType: 'direct', confidence: 92, status: 'suggested', description: 'Direct map of phone number.', createdAt: now },
  { id: 'map-cust-9', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'ADDR_JSON', targetTableId: 'customers_denorm', targetColumnId: 'address_street', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(ADDR_JSON, '$.street')", confidence: 70, status: 'suggested', description: 'Extract street from JSON.', createdAt: now },
  { id: 'map-cust-10', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'ADDR_JSON', targetTableId: 'customers_denorm', targetColumnId: 'address_city', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(ADDR_JSON, '$.city')", confidence: 70, status: 'suggested', description: 'Extract city from JSON.', createdAt: now },
  { id: 'map-cust-11', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'ADDR_JSON', targetTableId: 'customers_denorm', targetColumnId: 'address_state', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(ADDR_JSON, '$.state')", confidence: 70, status: 'suggested', description: 'Extract state from JSON.', createdAt: now },
  { id: 'map-cust-12', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'ADDR_JSON', targetTableId: 'customers_denorm', targetColumnId: 'address_postcode', transformationType: 'computed', formula: "JSON_EXTRACT_SCALAR(ADDR_JSON, '$.zip')", confidence: 70, status: 'suggested', description: 'Extract zip from JSON.', createdAt: now },
  { id: 'map-cust-13', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'JOIN_DT', targetTableId: 'customers_denorm', targetColumnId: 'joined_on', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of join date.', createdAt: now },
  { id: 'map-cust-14', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'STATUS', targetTableId: 'customers_denorm', targetColumnId: 'active_flag', transformationType: 'case_when', formula: "CASE WHEN STATUS = 'A' THEN 'Active' ELSE 'Inactive' END", confidence: 80, status: 'suggested', description: 'Map status flag to descriptive string.', createdAt: now },
  { id: 'map-cust-15', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'PREF_CHANNEL', targetTableId: 'customers_denorm', targetColumnId: 'preferred_contact', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of preferred channel.', createdAt: now },
  { id: 'map-cust-16', sourceTableId: 'DB2_CUSTOMERS', sourceColumnId: 'RISK_SCORE', targetTableId: 'customers_denorm', targetColumnId: 'customer_risk_score', transformationType: 'cast', formula: 'CAST(RISK_SCORE AS NUMERIC)', confidence: 75, status: 'suggested', description: 'Cast risk score to NUMERIC.', createdAt: now },
];

// Mappings for DB2_CLAIMS and related tables -> claims_denorm
export const claimsMappings: FieldMapping[] = [
  { id: 'map-claims-1', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'CLM_ID', targetTableId: 'claims_denorm', targetColumnId: 'claim_identifier', transformationType: 'direct', confidence: 95, status: 'suggested', description: 'Direct map of claim ID.', createdAt: now },
  { id: 'map-claims-2', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'POLICY_REF', targetTableId: 'claims_denorm', targetColumnId: 'policy_code', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of policy reference.', createdAt: now },
  { id: 'map-claims-3', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'CUSTOMER_REF', targetTableId: 'claims_denorm', targetColumnId: 'client_key', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of customer reference.', createdAt: now },
  { id: 'map-claims-4', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'CLM_DT', targetTableId: 'claims_denorm', targetColumnId: 'claim_open_date', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of claim date.', createdAt: now },
  { id: 'map-claims-5', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'CLM_STATUS', targetTableId: 'claims_denorm', targetColumnId: 'status_code', transformationType: 'cast', formula: 'CAST(CLM_STATUS AS STRING)', confidence: 92, status: 'suggested', description: 'Cast status to STRING.', createdAt: now },
  { id: 'map-claims-6', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'CLM_AMT', targetTableId: 'claims_denorm', targetColumnId: 'claim_value', transformationType: 'cast', formula: 'CAST(CLM_AMT AS NUMERIC)', confidence: 92, status: 'suggested', description: 'Cast claim amount to NUMERIC.', createdAt: now },
  { id: 'map-claims-7', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'ADJ_AMT', targetTableId: 'claims_denorm', targetColumnId: 'adjustment_value', transformationType: 'cast', formula: 'CAST(ADJ_AMT AS NUMERIC)', confidence: 92, status: 'suggested', description: 'Cast adjustment amount to NUMERIC.', createdAt: now },
  { id: 'map-claims-8', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'SETTLE_DT', targetTableId: 'claims_denorm', targetColumnId: 'resolution_date', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of settlement date.', createdAt: now },
  { id: 'map-claims-9', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'CLAIM_JSON', targetTableId: 'claims_denorm', targetColumnId: 'claim_detail_json', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of claim JSON.', createdAt: now },
  { id: 'map-claims-10', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'LOSS_TYPE', targetTableId: 'claims_denorm', targetColumnId: 'loss_category', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of loss type.', createdAt: now },
  { id: 'map-claims-11', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'REPORTED_BY', targetTableId: 'claims_denorm', targetColumnId: 'report_owner', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of reporter.', createdAt: now },
  { id: 'map-claims-12', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'INCIDENT_LOC', targetTableId: 'claims_denorm', targetColumnId: 'incident_address', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of incident location.', createdAt: now },
  { id: 'map-claims-13', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'INCIDENT_DT', targetTableId: 'claims_denorm', targetColumnId: 'incident_timestamp', transformationType: 'direct', confidence: 90, status: 'suggested', description: 'Direct map of incident timestamp.', createdAt: now },
  { id: 'map-claims-14', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'DAYS_OPEN', targetTableId: 'claims_denorm', targetColumnId: 'days_to_resolution', transformationType: 'cast', formula: 'CAST(DAYS_OPEN AS INT64)', confidence: 90, status: 'suggested', description: 'Cast days open to INT64.', createdAt: now },
  { id: 'map-claims-15', sourceTableId: 'DB2_CLAIMS', sourceColumnId: 'PRIORITY_CD', targetTableId: 'claims_denorm', targetColumnId: 'priority_level', transformationType: 'cast', formula: 'CAST(PRIORITY_CD AS STRING)', confidence: 90, status: 'suggested', description: 'Cast priority code to STRING.', createdAt: now },
  { id: 'map-claims-payments', sourceTableId: 'DB2_PAYMENTS', sourceColumnId: '*', targetTableId: 'claims_denorm', targetColumnId: 'payments', transformationType: 'custom', formula: 'ARRAY_AGG(STRUCT(...)) FROM DB2_PAYMENTS', confidence: 92, status: 'suggested', description: 'Aggregate payments into a nested array.', createdAt: now },
  { id: 'map-claims-adjustments', sourceTableId: 'DB2_ADJUSTMENTS', sourceColumnId: '*', targetTableId: 'claims_denorm', targetColumnId: 'adjustments', transformationType: 'custom', formula: 'ARRAY_AGG(STRUCT(...)) FROM DB2_ADJUSTMENTS', confidence: 90, status: 'suggested', description: 'Aggregate adjustments into a nested array.', createdAt: now },
  { id: 'map-claims-events', sourceTableId: 'DB2_CLAIM_EVENTS', sourceColumnId: '*', targetTableId: 'claims_denorm', targetColumnId: 'events', transformationType: 'custom', formula: 'ARRAY_AGG(STRUCT(...)) FROM DB2_CLAIM_EVENTS', confidence: 90, status: 'suggested', description: 'Aggregate events into a nested array.', createdAt: now },
];
